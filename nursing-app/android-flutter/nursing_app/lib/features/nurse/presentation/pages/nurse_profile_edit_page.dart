...
/// 护士端个人信息编辑页面
@RoutePage()
class NurseProfileEditPage extends ConsumerStatefulWidget {
  const NurseProfileEditPage({super.key});

  @override
  ConsumerState<NurseProfileEditPage> createState() =>
      _NurseProfileEditPageState();
}

class _NurseProfileEditPageState extends ConsumerState<NurseProfileEditPage> {
